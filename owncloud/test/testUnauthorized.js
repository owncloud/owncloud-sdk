...
console.log("Running Un-Authorized tests i.e tests with specifying wrong username and password");
...
var password 		 =  config.password + timeRightNow;
...
// CREATED SHARES
var sharedFilesWithUser = {1: '1', 2: '2'};
